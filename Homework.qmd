...
Отчет можно загрузить по ссылке.
...
You can use any dataset as input: your own, someone else's (e.g. from [here](https://geodacenter.github.io/data-and-lab/)) or synthetic. The choice of data is entirely up to you.
...
You can submit your free-form written report via link
